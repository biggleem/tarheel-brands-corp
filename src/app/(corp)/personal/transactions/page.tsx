...
function TableSkeleton() {
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader title="Personal Transactions" description="All personal financial transactions" />
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader
        ...
        description="All personal financial transactions from Rocket Money"
        actions={
