...
const mockTransactions: PlaidTransaction[] = [
  ...
  { id: 'tx-004', date: '2026-03-07', description: 'Spectrum Business Internet', amount: 189.99, direction: 'debit', category: 'utilities', business: 'Tarheel Brands Corp', account: 'Operating Account ****5567', institution: 'Wells Fargo', status: 'categorized' },
  { id: 'tx-005', date: '2026-03-07', description: 'GUSTO Payroll Processing', amount: 12480.00, direction: 'debit', category: 'payroll', business: 'Tarheel Brands Corp', account: 'Payroll Account ****2210', institution: 'Wells Fargo', status: 'categorized' },
  ...
  { id: 'tx-007', date: '2026-03-06', description: 'Meta Ads - Campaign 0306', amount: 450.00, direction: 'debit', category: 'marketing', business: 'Tarheel Brands Corp', account: 'Operating Account ****5567', institution: 'Wells Fargo', status: 'categorized' },
  { id: 'tx-008', date: '2026-03-06', description: 'Staples Office Supply', amount: 234.67, direction: 'debit', category: 'office', business: 'Tarheel Brands Corp', account: 'Business Plus Checking ****8834', institution: 'Chase', status: 'uncategorized' },
  ...
  { id: 'tx-010', date: '2026-03-05', description: 'State Farm Insurance Premium', amount: 1200.00, direction: 'debit', category: 'insurance', business: 'Tarheel Brands Corp', account: 'Operating Account ****5567', institution: 'Wells Fargo', status: 'categorized' },
  ...
  { id: 'tx-012', date: '2026-03-04', description: 'Canva Pro Subscription', amount: 12.99, direction: 'debit', category: 'subscriptions', business: 'Tarheel Brands Corp', account: 'Business Credit Card ****9104', institution: 'Bank of America', status: 'categorized' },
  ...
  { id: 'tx-016', date: '2026-03-02', description: 'Google Workspace - Monthly', amount: 72.00, direction: 'debit', category: 'subscriptions', business: 'Tarheel Brands Corp', account: 'Operating Account ****5567', institution: 'Wells Fargo', status: 'categorized' },
  ...
  { id: 'tx-018', date: '2026-03-01', description: 'QuickBooks Online', amount: 80.00, direction: 'debit', category: 'subscriptions', business: 'Tarheel Brands Corp', account: 'Operating Account ****5567', institution: 'Wells Fargo', status: 'categorized' },
  ...
  { id: 'tx-020', date: '2026-03-01', description: 'Verizon Wireless Business', amount: 245.00, direction: 'debit', category: 'utilities', business: 'Tarheel Brands Corp', account: 'Operating Account ****5567', institution: 'Wells Fargo', status: 'categorized' },
]
