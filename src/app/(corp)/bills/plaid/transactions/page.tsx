...
const mockTransactions: PlaidTransaction[] = [
  { id: 'tx-001', date: '2026-03-08', description: 'Sysco Foods Charlotte', amount: 2847.50, direction: 'debit', category: 'food_supplies', business: 'Metal Brixx Cafe', account: 'Business Checking ****4821', institution: 'Bank of America', status: 'categorized' },
  { id: 'tx-002', date: '2026-03-08', description: 'Square Payment - POS Revenue', amount: 4215.80, direction: 'credit', category: 'revenue', business: 'Metal Brixx Cafe', account: 'Business Checking ****4821', institution: 'Bank of America', status: 'categorized' },
  { id: 'tx-003', date: '2026-03-07', description: 'Duke Energy - Service Charge', amount: 847.50, direction: 'debit', category: 'utilities', business: 'Metal Brixx Cafe', account: 'Business Checking ****4821', institution: 'Bank of America', status: 'categorized' },
  ...
  { id: 'tx-006', date: '2026-03-06', description: 'Amazon Business - Kitchen supplies', amount: 342.18, direction: 'debit', category: 'food_supplies', business: 'Metal Brixx Cafe', account: 'Business Credit Card ****9104', institution: 'Bank of America', status: 'categorized' },
  ...
  { id: 'tx-009', date: '2026-03-05', description: 'Toast POS Revenue Deposit', amount: 3890.42, direction: 'credit', category: 'revenue', business: 'Metal Brixx Cafe', account: 'Business Checking ****4821', institution: 'Bank of America', status: 'categorized' },
  ...
  { id: 'tx-011', date: '2026-03-04', description: 'US Foods Delivery', amount: 1648.90, direction: 'debit', category: 'food_supplies', business: 'Metal Brixx Cafe', account: 'Business Checking ****4821', institution: 'Bank of America', status: 'categorized' },
  ...
  { id: 'tx-014', date: '2026-03-03', description: 'Crown Properties - Rent March', amount: 4500.00, direction: 'debit', category: 'rent', business: 'Metal Brixx Cafe', account: 'Business Checking ****4821', institution: 'Bank of America', status: 'categorized' },
  { id: 'tx-015', date: '2026-03-03', description: 'Toast POS Revenue Deposit', amount: 2918.65, direction: 'credit', category: 'revenue', business: 'Metal Brixx Cafe', account: 'Business Checking ****4821', institution: 'Bank of America', status: 'categorized' },
  ...
  { id: 'tx-017', date: '2026-03-02', description: 'Uber Eats - Marketplace Fee', amount: 186.40, direction: 'debit', category: 'marketing', business: 'Metal Brixx Cafe', account: 'Business Checking ****4821', institution: 'Bank of America', status: 'uncategorized' },
  ...
  { id: 'tx-019', date: '2026-03-01', description: 'Toast POS Revenue Deposit', amount: 5124.30, direction: 'credit', category: 'revenue', business: 'Metal Brixx Cafe', account: 'Business Checking ****4821', institution: 'Bank of America', status: 'categorized' },
